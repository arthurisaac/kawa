...
@section('main')
    @extends('bases.toolbar', ["title" => "Regulation", "subTitle" => "Sortie stock"])
                    ...
                    <div class="card-body bg-card-kawa 2">
                        <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-7">
                            ...
                            <div class="flex-grow-1 me-2">
                                <a href="#" class="fw-bolder text-gray-800 text-hover-primary fs-6">Quantité Sortie :</a>
                                <span class="text-muted fw-bold d-block"></span>
                            </div>
                            <!--end::Title-->
                            <!--begin::Lable-->
                            <span class="fw-bolder text-danger py-1 quantiteSortie" id="quantiteSortie">{{ $stocks->sum("qte_sortie") }}</span>
                            <!--end::Lable-->
                        </div>
                ...
                <form action="#" method="get">
                    ...
                    <div class="card card-xl-stretch">
                        ...
                        <div class="card-footer">
                            <a href="/regulation-stock-sortie-liste-detaillee" class="btn btn-info btn-sm">Effacer</a>
                            <button class="btn btn-primary btn-sm" type="submit">Rechercher</button>
                            <a href="/regulation-stock-sortie" class="btn btn-sm btn-primary">Nouveau</a>
                        </div>
                    </div>
                    @csrf
