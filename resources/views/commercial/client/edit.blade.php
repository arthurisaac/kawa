                                        ...
                                        <div class="col">
                                            ...
                                            <div>
                                                <a href="javascript:popupwnd('commercial-site','no','no','no','no','no','no','','','1200','600')"
                                                   target="_self" class="btn btn-sm btn-info" type="button"
                                                   style="min-width: 150px">Site</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="two-columns" style="justify-content: start;">
                                                <div>
                                                    <div class="checkbox">
                                                        <input type="checkbox" id="cb_tdf_vb" name="contrat_objet[]"
                                                               value="TDF VB">
                                                        <label for="cb_tdf_vb">TDF VB</label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <input type="checkbox" id="cb_tdf_vl" name="contrat_objet[]"
                                                               value="TDF VL">
                                                        <label for="cb_tdf_vl">TDF VL</label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <input type="checkbox" id="cb_tdf_mad" name="contrat_objet[]"
                                                               value="MAD CAISSE">
                                                        <label for="cb_tdf_mad">MAD CAISSE</label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <input type="checkbox" id="cb_collecte" name="contrat_objet[]"
                                                               value="Collecte">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="checkbox">
                                                        <input type="checkbox" id="cb_gestion_atm" name="contrat_objet[]"
                                                               value="Gestion ATM">
                                                    ...
                                                    <div class="checkbox">
                                                        <input type="checkbox" id="Checkbox2" name="contrat_objet[]"
                                                               value="Consommable ATM">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="checkbox">
                                                <input type="checkbox" id="cb_fo_permanent" name="contrat_frequence_op[]"
                                                       value="Permanent">
                                            ...
                                            <div>Régime</div>
                                            <div class="checkbox">
                                                <input type="checkbox" id="cb_intra_muros" name="contrat_regime[]"
                                                       value="Intra muros">
                                        ...
                                        <div class="col">
                                            ...
                                            <div>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" value="extra grand"
                                                           name="base_petit_materiel_securipack"
                                                           id="base_petit_materiel_securipack">
                                                    <label class="form-check-label" for="base_petit_materiel_securipack">
                                                        Extra grand
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" value="grand"
                                                           name="base_petit_materiel_securipack" id="flexCheckDefault">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" value="petit"
                                                           name="base_petit_materiel_securipack" id="flexCheckDefault">
                                                    <label class="form-check-label">
                                                        Petit
                                                    </label>
                                            ...
                                            <div>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" value="extra grand"
                                                           name="base_petit_materiel_sacjute"
                                                           id="base_petit_materiel_sac_jute">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" value="moyen"
                                                           name="base_petit_materiel_sacjute" id="flexCheckDefault">
                                                    <label class="form-check-label" for="base_petit_materiel_sac_jute">
                                                        Moyen
                                                    </label>
                                                </div>
                                            ...
                                            <div>
                                                <label>Scellé :</label>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" value="scelle"
                                                           id="base_petit_materiel_scelle"
                                                           name="base_petit_materiel_scelle">
                                                ...
                                                <div>
                                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                                        ...
                                                        <input type="number" min="0"
                                                               name="base_garde_de_fonds_montant_forfaitaire"
                                                               value="{{$client->base_garde_de_fonds_montant_forfaitaire}}"
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="text" name="base_comptage_montant_forfaitaire"
                                                       ...
                                                       id="bt_comptage_montant_forfaitaire" class="form-control col-sm-7">
                                            </div>
                                            <br/>
                                            <h6>ATM</h6>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" value="gestion" name="bt_atm"
                                                       id="bt_atm">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" value="maintenance"
                                                       name="bt_atm" id="bt_atm">
                                                <label class="form-check-label" for="bt_atm">
                                                    Maintenance
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" value="consommable"
                                                       name="bt_atm" id="bt_atm">
                                                <label class="form-check-label" for="bt_atm">
                                                    Consommable
                                                </label>
