                        ...
                        <div class="row">
                                    ...
                                    <div>
                                        <div class="form-group row">
                                            ...
                                            <input type="number" min="0"
                                                   name="base_garde_de_fonds_montant_forfaitaire" class="editbox col-sm-6">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" name="base_comptage_montant_forfaitaire" id="bt_comptage_montant_forfaitaire" class="editbox col-sm-7">
                                </div>
                                <br/>
                                <h6>ATM</h6>
