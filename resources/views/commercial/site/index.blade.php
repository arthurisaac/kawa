                ...
                <div class="card card-xxl-stretch">
                    <div class="card-body pt-5">
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                    <label for="nom_contact" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Nom de contact site</label>
                                    <input type="text" class="form-control col editbox" name="nom_contact" id="nom_contact" required>
                                </div>
                            </div>
                            <div class="col">
                                <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                    <label for="fonction_contact" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Fonction du contact</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                    <label for="centre" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Centre</label>
                            ...
                            <div class="col">
                                <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                    <label for="centre_regional" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Centre régional</label>
                            ...
                            <div class="col">
                                <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                    <label for="telephone" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Téléphone</label>
                                    <input type="tel" class="form-control col editbox" name="telephone" id="telephone" required>
                                </div>
                            </div>
                            <div class="col">
                                <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                    <label for="numero_de_carte" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Numéro de carte</label>
                        ...
                        <div class="tab-pane fade show active" id="transport-c" role="tabpanel"
                            ...
                            <div class="row">
                                <div class="col">
                                    <h6>Transport</h6>
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">VB extramuros bitume</label>
                                        <input type="number" class="col-sm-6 form-control form-control-sm"
                                               name="oo_vb_extamuros_bitume"
                                               id="oo_tdf_vb">
                                    </div>
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">VB extramuros piste</label>
                                        <input type="number" class="col-sm-6 form-control form-control-sm"
                                               name="oo_vb_extramuros_piste"
                                               id="oo_tdf_vl">
                                    </div>
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">VL extramuros bitume</label>
                                        <input type="number" class="col-sm-6 form-control form-control-sm"
                                               name="oo_vl_extramuros_bitume">
                                    </div>
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">VL extramuros piste</label>
                                        <input type="number" class="col-sm-6 form-control form-control-sm"
                                               name="oo_vl_extramuros_piste">
                                    </div>
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">VB (INTRAMUROS)</label>
                                        <input type="number" class="col-sm-6 form-control form-control-sm"
                                               name="oo_vb_intramuros">
                                    </div>
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label for="oo_tdf_vl" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">VL (INTRAMUROS)</label>
                                        <input type="number" class="col-sm-6 form-control form-control-sm"
                                               name="oo_vl_intramuros"
                                               id="oo_tdf_vl">
                                    </div>
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label for="oo_ass_appro" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Assistance appro dab</label>
                                        <input type="number" class="col-sm-6 form-control form-control-sm"
                                               name="oo_ass_appro" id="oo_ass_appro">
                                    </div>
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label for="oo_dnf" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Dépôt non facturé</label>
                                        <input type="number" class="col-sm-6 form-control form-control-sm"
                        ...
                        <div class="tab-pane fade" id="atm-c" role="tabpanel" aria-labelledby="atm-tab">
                            <div class="row">
                                <div class="col">
                                    <h6>ATM</h6>
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Borne chèque</label>
                                        <input type="text" class="col-sm-6 form-control form-control-sm"
                                               name="oo_borne_cheque">
                                    </div>
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Borne des opérations</label>
                                        <input type="text" class="col-sm-6 form-control form-control-sm"
                                               name="oo_borne_operation">
                                    </div>
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Gestion des GAB</label>
                                        <input type="text" class="col-sm-6 form-control form-control-sm"
                                               name="oo_gestion_gab"/>
                                        {{--<div class="row">
                                    ...
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Maintenance N2\N3</label>
                                        <input type="number" class="col-sm-6 form-control form-control-sm"
                                               name="oo_maintenance_n2"
                                               id="oo_garde_fond">
                                    </div>
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Vente\location ATM</label>
                                        <input type="number" class="col-sm-6 form-control form-control-sm"
                                               name="oo_vente_location"
                                               id="oo_garde_fond">
                                    </div>
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Vente consommables</label>
                                        <input type="number" class="col-sm-6 form-control form-control-sm"
                                               name="oo_vente_consommables"
                                               id="oo_garde_fond">
                                    </div>
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Vente pièces détachées</label>
                                        <input type="number" class="col-sm-6 form-control form-control-sm"
                            ...
                            <div class="col-10">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <h6>CAISSIERES</h6>
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Garde de fond</label>
                                            <input type="text" class="col-sm-6 form-control form-control-sm" name="oo_garde_fond">
                                        </div>
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Opération comptage BCEAO</label>
                                            <input type="text" class="col-sm-6 form-control form-control-sm" name="oo_comptage">
                                        </div>
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Opération dispatching</label>
                                            <input type="text" class="col-sm-6 form-control form-control-sm" name="oo_dispatching">
                                        </div>
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">MAD</label>
                                            <input type="number" class="col-sm-6 form-control form-control-sm" name="oo_mad">
                                        </div>
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Collecte</label>
                                            <input type="number" class="col-sm-6 form-control form-control-sm"
                                                   name="oo_collecte">
                                        </div>
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">CCTV</label>
                                            <input type="number" class="col-sm-6 form-control form-control-sm"
                                                   name="oo_cctv">
                                        </div>
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Collecte caisse</label>
                                            <input type="number" class="col-sm-6 form-control form-control-sm"
                        ...
                        <div class="tab-pane fade" id="materiel-c" role="tabpanel" aria-labelledby="materiel-tab">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Extra grand</label>
                                    ...
                                    <div class="col">
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Grand</label>
                                            <input type="number" min="0" class="col-sm-6 form-control form-control-sm"
                                    ...
                                    <div class="col">
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Moyen</label>
                                            <input type="number" min="0" class="col-sm-6 form-control form-control-sm"
                                    ...
                                    <div class="col">
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Petit</label>
                                            <input type="number" min="0" class="col-sm-6 form-control form-control-sm"
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Extra Grand</label>
                                            <input type="number" class="col-sm-6 form-control form-control-sm"
                                    ...
                                    <div class="col-3">
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Grand</label>
                                            <input type="number" class="col-sm-6 form-control form-control-sm"
                                    ...
                                    <div class="col-3">
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Moyen</label>
                                            <input type="number" class="col-sm-6 form-control form-control-sm"
                                    ...
                                    <div class="col-3">
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label for="cb_tdf_vb" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Petit</label>
                                            <input type="number" class="col-sm-6 form-control form-control-sm"
