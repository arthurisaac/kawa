            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="finances" role="tabpanel" aria-labelledby="finances-tab">
                    <div class="container">
                        ...
                        <table class="table table-striped gy-7 gs-7 pt-0" style="width: 100%" id="financeTable">
                            <thead>
                            ...
                            <div class="col-6">
                                <div class="form-group row">
                                    ...
                                    <select name="condition" class="form-control col-sm-7">
                                        <option>{{$fournisseur->condition}}</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <select name="mode_paiement" class="form-control col-sm-7">
                                        <option>{{$fournisseur->mode_paiement}}</option>
