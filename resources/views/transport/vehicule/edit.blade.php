        ...
        <form method="post" action="{{ route('vehicule.update', $vehicule->id) }}">
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="immatriculation" value="{{$vehicule->immatriculation}}" required/>
                    </div>
                    <div class="form-group">
                        <label>Marque</label>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        <label>Code</label>
                        <input type="text" class="form-control" name="code"  value="{{$vehicule->code}}"/>
                    </div>
                    <div class="form-group">
                        <label>DPMC</label>
                        <input type="date" class="form-control" name="DPMC"  value="{{$vehicule->DPMC}}"/>
                    </div>
                    <div class="form-group">
                        <label>Centre</label>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="num_chassis"  value="{{$vehicule->num_chassis}}"/>
                    </div>
                    <div class="form-group">
                        <label>Date d'aquisition</label>
                        <input type="date" class="form-control" name="dateAcquisition"  value="{{$vehicule->dateAcquisition}}" required/>
                    </div>
                    <div class="form-group">
                        <label>Centre régional</label>
                        <select class="form-control" name="centreRegional" id="centre_regional" required>
                ...
                <div class="col">
                    <div class="form-group row">
                        ...
                        <select class="editbox col-md-4" name="chauffeurTitulaire" id="chauffeurTitulaire">
                            <option value="{{$vehicule->chauffeurTitulaire}}">{{$vehicule->chauffeurTitulaires->matricule ?? $vehicule->chauffeurTitulaire}}</option>
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" class="editbox col-md-4" name="chauffeurTitulaireNomPrenoms"
                               id="chauffeurTitulaireNomPrenoms" value="{{$vehicule->chauffeurTitulaires->nomPrenoms ?? ''}}" readonly/>
                    </div>
                    {{--<div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" class="editbox col-md-4" name="chauffeurTitulaireFonction"
                               id="chauffeurTitulaireFonction" value="{{$vehicule->chauffeurTitulaires->fonction ?? ''}}" readonly/>
                    </div>
                    {{--<div class="form-group row">
                        <label class="col-md-3">Matricule</label>
                    ...
                    <div class="form-group row">
                        ...
                        <input type="date" class="editbox col-md-4" name="chauffeurTitulaireDateAffection"
                               id="chauffeurTitulaireDateAffection" readonly value="{{$vehicule->chauffeurTitulaires->dateEntreeSociete ?? ''}}"/>
                    </div>
                </div>
            </div>
            <br/>
                ...
                <div class="col">
                    <div class="form-group row">
                        ...
                        <select class="editbox col-md-4" name="chauffeurSuppleant" id="chauffeurSuppleant" >
                            <option value="{{$vehicule->chauffeurSuppleant}}">{{$vehicule->chauffeurSuppleants->matricule ?? $vehicule->chauffeurSuppleant}}</option>
                            @foreach($personnels as $personnel)
                                <option value="{{$personnel->id}}">{{$personnel->matricule}} | {{$personnel->nomPrenoms}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" class="editbox col-md-4" name="chauffeurSuppleantNomPrenoms"
                               id="chauffeurSuppleantNomPrenoms" value="{{$vehicule->chauffeurSuppleants->nomPrenoms ?? ''}}" readonly/>
                    </div>
                    {{--<div class="form-group row">
                        <label class="col-md-3">Prénom</label>
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" class="editbox col-md-4" name="chauffeurSuppleantFonction"
                               id="chauffeurSuppleantFonction" value="{{$vehicule->chauffeurSuppleants->fonction ?? ''}}" readonly/>
                    </div>
                    {{--<div class="form-group row">
                        <label class="col-md-3">Matricule</label>
                    ...
                    <div class="form-group row">
                        ...
                        <input type="date" class="editbox col-md-4" name="chauffeurSuppleantDateAffection"
                               id="chauffeurSuppleantDateAffection" value="{{$vehicule->chauffeurSuppleants->dateEntreeSociete ?? ''}}" readonly/>
                    </div>
                </div>
            </div>
            <br/>
