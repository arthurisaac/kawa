...
@section('main')
    @extends('bases.toolbar', ["title" => "Transport", "subTitle" => "Liste Entretien Véhicule"])
@section("nouveau")
                                ...
                                @foreach ($vidangeGenerale as $vidange)
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <a href="/vidange-generale/{{$vidange->id}}/edit"
                                ...
                                @foreach ($vidangePonts as $vidange)
                                    ...
                                    <!--<td>{{date('Y-m-d H:i:s'), strtotime($vidange->date. ' + 5 days')}}</td>-->
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <a href="/vidange-pont/{{$vidange->id}}/edit"
                                               class="btn btn-primary btn-sm"></a>
                                        </td>
                                    </tr>
                                ...
                                @foreach ($vidangePatentes as $vidange)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="/vidange-patente/{{$vidange->id}}/edit"
                                               class="btn btn-primary btn-sm"></a>
                                        </td>
                                    </tr>
                                @endforeach
                                ...
                                @foreach ($vidangeCourroie as $vidange)
                                    ...
                                    $vidange->filtreGazoilMontant + $vidange->filtreAirMontant }}
                                        ...
                                        <td>
                                            ...
                                            <a href="/vidange-courroie/{{$vidange->id}}/edit"
                                               class="btn btn-primary btn-sm"></a>
                                        </td>
                                    </tr>
                                @endforeach
                                ...
                                @foreach ($vidangeVignette as $vidange)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/vidange-vignette/{{$vidange->id}}/edit"
                                               class="btn btn-primary btn-sm"></a>
                                        </td>
                                    </tr>
                                ...
                                @foreach ($vidangeTransport as $vidange)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/vidange-transport/{{$vidange->id}}/edit"
                                               class="btn btn-primary btn-sm"></a>
                                        </td>
                                    </tr>
                                @endforeach
                                ...
                                @foreach ($vidangeVisite as $vidange)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/vidange-visite/{{$vidange->id}}/edit"
                                               class="btn btn-primary btn-sm"></a>
                                        </td>
                                    </tr>
                                @endforeach
                                ...
                                @foreach ($assurances as $assurance)
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <a href="/vidange-assurance/{{$assurance->id}}/edit"
                                               class="btn btn-primary btn-sm"></a>
                                        </td>
                                    </tr>
                                @endforeach
