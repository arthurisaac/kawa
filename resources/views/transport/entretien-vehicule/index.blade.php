...
<div class="row">
    <div>
        ...
        <a id="Button2" href="javascript:popupwnd('./vidange-huile-pont.html','no','no','no','yes','yes','no','','','1000','600')" target="_self" style="position:absolute;left:190px;top:30px;width:149px;height:82px;z-index:1;">Vidange huile de pont</a>
        <a id="Button3" href="javascript:popupwnd('./courroie.html','no','no','no','yes','yes','no','','','1000','600')" target="_self" style="position:absolute;left:360px;top:30px;width:129px;height:82px;z-index:2;">Courroie</a>
