            ...
            <table class="table table-bordered" id="sitesListes">
                ...
                @foreach($sites as $site)
                    <tr>
                        ...
                        <td><input type="number" min="0" name="valeur_colis_xof[]" value="{{$site->valeur_colis_xof_arrivee}}" class="form-control"></td>
                        <td><input type="number" min="0" name="device_etrangere_dollar[]" value="{{$site->device_etrangere_dollar_arrivee}}" class="form-control"></td>
                        <td><input type="number" min="0" name="device_etrangere_euro[]" value="{{$site->device_etrangere_euro_arrivee}}" class="form-control"></td>
                        <td><input type="number" min="0" name="pierre_precieuse[]" value="{{$site->pierre_precieuse_arrivee}}" class="form-control"></td>
                        <td><textarea name="numero[]" class="form-control">{{$site->numero_arrivee}}</textarea></td>
                        <td><input type="number" name="nbre_colis[]" value="{{$site->nbre_colis_arrivee}}" class="form-control"></td>
