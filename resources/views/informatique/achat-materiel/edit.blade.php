...
@section('main')
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <div id="kt_content_container" class="container-xxl">
            ...
            @endif
                <form enctype="multipart/form-data" method="post" action="{{ route('informatique-achat-materiel.update', $achat->id) }}">
                    @csrf
                    @method('PATCH')
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        ...
                                        <input class="form-control col-md-7" value="{{$achat->service}}" name="service"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="date" class="form-control col-md-7" value="{{$achat->date_achat}}" name="date_achat" id="date_achat" />
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label class="d-flex align-items-center fs-6 fw-bold form-label text-dark mb-2">Duree de vie</label>
                                        <input type="number" class="form-control col-md-7" value="{{$achat->prixUnitaire}}" name="duree" id="duree" readonly />
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label for="caracteristique" class="d-flex align-items-center fs-6 fw-bold form-label text-dark mb-2">Caracteristique</label>
                                        <textarea class="form-control col-md-7" value="{{$achat->quantite}}" name="caracteristique" id="caracteristique"></textarea>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label class="d-flex align-items-center fs-6 fw-bold form-label text-dark mb-2">Prix unitaire</label>
                                        <input type="number" class="form-control col-md-7" value="{{$achat->prixUnitaire}}" name="prixUnitaire" id="prixUnitaire"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="number" value="{{$achat->quantite}}" class="form-control col-md-7" name="quantite" id="quantite" min="0" value="0"/>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        <label class="d-flex align-items-center fs-6 fw-bold form-label text-dark mb-2">Montant</label>
                                        <input type="number" class="form-control col-md-7" value="{{$achat->montant}}" name="montant" id="montant" readonly/>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                ...
                                <div class="col">
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="date" class="form-control col-md-7"  value="{{$achat->date_fin}}"  name="date_fin" id="date_fin" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" class="form-control col-md-7" value="{{$achat->reference}}" name="reference" />
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
