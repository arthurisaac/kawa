    ...
    @endif
        <div class="row gy-5 g-xxl-12">
            <div class="col-xxl-12">
                <form class="form-horizontal" method="post" action="{{ route('logistique-sortie-maintenance.store') }}">
...
{{--    <form method="post" action="{{ route('logistique-sortie-maintenance.store') }}">--}}
{{--        @csrf--}}
