...
@section('main')
    @extends('bases.toolbar', ["title" => "Logistique", "subTitle" => "Sortie fiche approvisionnement DAB"])
    ...
    @endif
        <div class="row gy-5 g-xxl-12">
            <div class="col-xxl-12">
                <form class="form-horizontal" method="post" action="{{ route('logistique-sortie-approvision.store') }}">
                    <div class="card card-xxl-stretch">
                        <div class="card-header border-0 py-5 bg-warning">
                            <h3 class="card-title fw-bolder">Sortie maintenance DAB</h3>
                        </div>
...
{{--    <form method="post" action="{{ route('logistique-sortie-approvision.store') }}">--}}
{{--        @csrf--}}
