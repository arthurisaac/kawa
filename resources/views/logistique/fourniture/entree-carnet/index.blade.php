...
@section('main')
    @extends('bases.toolbar', ["title" => "Logistique", "subTitle" => "Entrée carnet caisse"])
<div class="burval-container">
    <div><h2 class="heading">Entree carnet caisse</h2></div>
    <br/>
    @if ($errors->any())
    ...
    <div class="row gy-5 g-xxl-12">
        <div class="col-xxl-12">
            <form class="form-horizontal" method="post" action="{{ route('logistique-entree-carnet.store') }}">
                <div class="card card-xxl-stretch">
                    <div class="card-header border-0 py-5 bg-warning">
                        <h3 class="card-title fw-bolder">Entrée bordereau</h3>
                    </div>
                    <div class="card-body pt-5">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group row">
                                    <label for="fournisseur" class="col-sm-5">Fournisseurs</label>
...
{{--    <form method="post" action="{{ route('logistique-entree-carnet.store') }}">--}}
{{--        @csrf--}}
