...
<div class="burval-container">
    ...
    <form method="post" action="{{ route('logistique-entree-securipack.update', $entree->id) }}">
        @method('PATCH')
        @csrf
        <div class="row">
            <div class="col">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="form-control col-sm-7" name="reference" value="{{$entree->reference}}" required />
                </div>
            </div>
            <div class="col-2">
