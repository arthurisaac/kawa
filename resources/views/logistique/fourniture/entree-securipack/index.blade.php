...
@section('main')
    @extends('bases.toolbar', ["title" => "Logistique", "subTitle" => "Entrée sécuripack"])
    ...
    @endif
        ...
        <div class="row gy-5 g-xxl-12">
            <div class="col-xxl-12">
                <form class="form-horizontal" method="post" action="{{ route('logistique-entree-securipack.store') }}">
...
{{--    <form method="post" action="{{ route('logistique-entree-securipack.store') }}">--}}
{{--        @csrf--}}
...
{{--                    <input type="text" class="form-control col-sm-7" name="reference" required />--}}
{{--                </div>--}}
{{--            </div>--}}
{{--            <div class="col-2">--}}
{{--                <button class="btn btn-primary btn-sm" type="submit">Valider</button>--}}
