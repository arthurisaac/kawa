                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control col" value="{{$produit->reference}}" id="reference" name="reference" required>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label for="libelle" class="d-flex align-items-center fs-6 fw-bold form-label text-dark mb-2">Libellé</label>
                                            <input type="text" class="form-control col" value="{{$produit->libelle}}" name="libelle" id="libelle" required>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label for="description" class="d-flex align-items-center fs-6 fw-bold form-label text-dark mb-2">Description</label>
                                            <textarea class="form-control col" name="description" id="description" required>{{$produit->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col">
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="number" class="form-control col" value="{{$produit->seuil}}" name="seuil" id="seuil" required>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label for="stockAlert" class="d-flex align-items-center fs-6 fw-bold form-label text-dark mb-2">Stock alert</label>
                                            <input type="number" class="form-control col" value="{{$produit->stockAlert}}" name="stockAlert" id="stockAlert" required>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label for="ves" class="d-flex align-items-center fs-6 fw-bold form-label text-dark mb-2">Ves (Vital ou non)</label>
                                            <input type="text" class="form-control col" value="{{$produit->ves}}" name="ves" id="ves" required>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label for="prix" class="d-flex align-items-center fs-6 fw-bold form-label text-dark mb-2">Prix (HT)</label>
                                            <input type="number" class="form-control col"  value="{{$produit->prix}}" name="prix" id="prix" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
