...
@section('main')
    <!--begin::Toolbar-->
    @extends('bases.toolbar', ["title" => "Caisse Centrale", "subTitle" => "Caisse centrale modification entrée colis"])
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="row gy-5 g-xxl-12">
                <div class="col-xxl-12">
                    <form class="form-horizontal" action="{{ route('caisse-entree-colis.update', $colis->id) }}" id="target" method="post">
                        @csrf
                        @method("PATCH")
                        <div class="card card-xxl-stretch">
                            ...
                            <div class="card-body pt-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="d-flex flex-column mb-7 col-md-3 fv-row fv-plugins-icon-container">
                                        <label for="remettant" class="d-flex align-items-center fs-6 fw-bold form-label text-black-50 mb-2">Rémettant (Agent de régulation)</label>
                                        <input type="text" class="col-sm-6 form-control form-control" name="remettant" id="remettant" value="{{$colis->remettant}}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
...
background: linear-gradient(0deg, rgba(148,148,152,0.34217436974789917) 0%, rgba(220,211,172,1) 38%, rgba(255,216,1,1) 100%)!important;">
                                ...
                                @foreach($items as $item)
                                    <tr>
                                        ...
                                        <td><input type="number" name="caisse_entree_valeur_colis[]" value="{{$item->caisse_entree_valeur_colis ?? 0}}" class="form-control"></td>
