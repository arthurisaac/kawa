                ...
                <div class="card card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body pt-2">
                        ...
                        <div class="d-flex align-items-center bg-light-info rounded p-5 mb-7">
                            ...
                            <!--end::Title-->
                            <!--begin::Lable-->
                            <span class="fw-bolder text-danger py-1">{{$colis->sum("caisse_entree_valeur_colis")}}</span>
                            <!--end::Lable-->
                        </div>
                    </div>
                    <!--end::Body-->
                ...
                <form action="#" method="get">
                    ...
                    <div class="card card-xxl-stretch">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="/caisse-entree-colis" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app"
