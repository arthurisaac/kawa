            ...
            <div class="row">
                <div class="col">
                    <div class="form-group row">
                        ...
                        <input type="time" name="heurePriseBox" value="{{$ctv->heurePriseBox}}" class="form-control col-sm-7" />
                    </div>
                </div>
                <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="number" min="0" name="montantFinal" id="montantFinal" class="form-control col-sm-7"
