            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="time" value={{$ctv->heurePriseBox}} name="heurePriseBox" class="form-control col-sm-7" required/>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="time" value={{$ctv->heureFinBox}} name="heureFinBox" id="heureFinBox" class="form-control col-sm-7"/>
                    </div>
                </div>
                <div class="col"></div>
            </div><br />
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group row">
                        ...
                        <input type="number"  value={{$ctv->nombreColis}} name="nombreColis" id="nombreColis" class="form-control col-sm-7"/>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group row">
                        <label for="numeroScelleColis" class="col-sm-5">Numero de scellé</label>
                        <input type="number" value={{$ctv->numeroScelleColis}} name="numeroScelleColis" id="numeroScelleColis" class="form-control col-sm-7"/>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group row">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text"  value="{{$ctv->expediteur}}" class="form-control col-sm-7" id="expediteur" name="expediteur" required />
                    </div>
                    <div class="form-group row">
                        <label for="caisse_desti" class="col-sm-5">Destinataire</label>
                        <input type="text"  value="{{$ctv->destinataire}}" class="form-control col-sm-7" id="destinataire" name="destinataire" required />
                    </div>
                </div>
                <div class="col">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        <tr>
                            <td><input type="number" value="{{$billetage->ba_nb10000}}" min="0" class="form-control form-control-sm" name="ba_nb10000" id="ba_nb10000" /></td>
                            <td>10000</td>
                        ...
                        <tr>
                            <td><input type="number" value="{{$billetage->ba_nb5000}}" min="0" class="form-control form-control-sm" name="ba_nb5000" id="ba_nb5000" /></td>
                            <td>5000</td>
                        ...
                        <tr>
                            <td><input type="number" value="{{$billetage->ba_nb2000}}" min="0" class="form-control form-control-sm" name="ba_nb2000" id="ba_nb2000" /></td>
                            <td>2000</td>
                        ...
                        <tr>
                            <td><input type="number"  value="{{$billetage->ba_nb1000}}" min="0" class="form-control form-control-sm" name="ba_nb1000" id="ba_nb1000" /></td>
                            <td>1000</td>
                        ...
                        <tr>
                            <td><input type="number"  value="{{$billetage->ba_nb500}}" min="0" class="form-control form-control-sm" name="ba_nb500" id="ba_nb500" /></td>
                            <td>500</td>
                        ...
                        <tr>
                            <td><input type="number"  value="{{$billetage->ba_nb250}}" min="0" class="form-control form-control-sm" name="ba_nb250" id="ba_nb250" /></td>
                            <td>250</td>
                        ...
                        <tr>
                            <td><input type="number"  value="{{$billetage->ba_nb200}}" min="0" class="form-control form-control-sm" name="ba_nb200" id="ba_nb200" /></td>
                            <td>200</td>
                        ...
                        <tr>
                            <td><input type="number"  value="{{$billetage->ba_nb100}}" min="0" class="form-control form-control-sm" name="ba_nb100" id="ba_nb100" /></td>
                            <td>100</td>
                        ...
                        <tr>
                            <td><input type="number"  value="{{$billetage->ba_nb50}}" min="0" class="form-control form-control-sm" name="ba_nb50" id="ba_nb50" /></td>
                            <td>50</td>
                        ...
                        <tr>
                            <td><input type="number"  value="{{$billetage->ba_nb25}}" min="0" class="form-control form-control-sm" name="ba_nb25" id="ba_nb25" /></td>
                            <td>25</td>
                        ...
                        <tr>
                            <td><input type="number"  value="{{$billetage->ba_nb10}}" min="0" class="form-control form-control-sm" name="ba_nb10" id="ba_nb10" /></td>
                            <td>10</td>
                        ...
                        <tr>
                            <td><input type="number"  value="{{$billetage->ba_nb5}}" min="0" class="form-control form-control-sm" name="ba_nb5" id="ba_nb5" /></td>
                            <td>5</td>
                        ...
                        <tr>
                            <td><input type="number"  value="{{$billetage->ba_nb1}}" min="0" class="form-control form-control-sm" name="ba_nb1" id="ba_nb1" /></td>
                            <td>1</td>
                ...
                <div class="col">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        <tr>
                            <td><input type="number" value="{{$billetage->br_nb10000}}" min="0" class="form-control form-control-sm" name="br_nb10000" id="br_nb10000" /></td>
                            <td>10000</td>
                            <td><input type="number" min="0" class="form-control form-control-sm" name="br_nb10000_total" id="br_nb10000_total" readonly /></td>
                        </tr>
                        <tr>
                            <td><input type="number" value="{{$billetage->br_nb5000}}" min="0" class="form-control form-control-sm" name="br_nb5000" id="br_nb5000" /></td>
                            <td>5000</td>
                            <td><input type="number" min="0" class="form-control form-control-sm" name="br_nb5000_total" id="br_nb5000_total" readonly /></td>
                        </tr>
                        <tr>
                            <td><input type="number" value="{{$billetage->br_nb2000}}" min="0" class="form-control form-control-sm" name="br_nb2000" id="br_nb2000" /></td>
                            <td>2000</td>
                            <td><input type="number" min="0" class="form-control form-control-sm" name="br_nb2000_total" id="br_nb2000_total" readonly /></td>
                        </tr>
                        <tr>
                            <td><input type="number" value="{{$billetage->br_nb1000}}" min="0" class="form-control form-control-sm" name="br_nb1000" id="br_nb1000" /></td>
                            <td>1000</td>
                            <td><input type="number" min="0" class="form-control form-control-sm" name="br_nb1000_total" id="br_nb1000_total" readonly /></td>
                        </tr>
                        <tr>
                            <td><input type="number" value="{{$billetage->br_nb500}}" min="0" class="form-control form-control-sm" name="br_nb500" id="br_nb500" /></td>
                            <td>500</td>
                            <td><input type="number" min="0" class="form-control form-control-sm" name="br_nb500_total" id="br_nb500_total" readonly /></td>
                        </tr>
                        <tr>
                            <td><input type="number" value="{{$billetage->br_nb250}}" min="0" class="form-control form-control-sm" name="br_nb250" id="br_nb250" /></td>
                            <td>250</td>
                            <td><input type="number" min="0" class="form-control form-control-sm" name="br_nb250_total" id="br_nb250_total" readonly /></td>
                        </tr>
                        <tr>
                            <td><input type="number" value="{{$billetage->br_nb200}}" min="0" class="form-control form-control-sm" name="br_nb200" id="br_nb200" /></td>
                            <td>200</td>
                            <td><input type="number" min="0" class="form-control form-control-sm" name="br_nb200_total" id="br_nb200_total" readonly /></td>
                        </tr>
                        <tr>
                            <td><input type="number" value="{{$billetage->br_nb100}}" min="0" class="form-control form-control-sm" name="br_nb100" id="br_nb100" /></td>
                            <td>100</td>
                            <td><input type="number" min="0" class="form-control form-control-sm" name="br_nb100_total" id="br_nb100_total" readonly /></td>
                        </tr>
                        <tr>
                            <td><input type="number" value="{{$billetage->br_nb50}}" min="0" class="form-control form-control-sm" name="br_nb50" id="br_nb50" /></td>
                            <td>50</td>
                            <td><input type="number" min="0" class="form-control form-control-sm" name="br_nb50_total" id="br_nb50_total" readonly /></td>
                        </tr>
                        <tr>
                            <td><input type="number" value="{{$billetage->br_nb25}}" min="0" class="form-control form-control-sm" name="br_nb25" id="br_nb25" /></td>
                            <td>25</td>
                            <td><input type="number" min="0" class="form-control form-control-sm" name="br_nb25_total" id="br_nb25_total" readonly /></td>
                        </tr>
                        <tr>
                            <td><input type="number" value="{{$billetage->br_nb10}}" min="0" class="form-control form-control-sm" name="br_nb10" id="br_nb10" /></td>
                            <td>10</td>
                            <td><input type="number" min="0" class="form-control form-control-sm" name="br_nb10_total" id="br_nb10_total" readonly /></td>
                        </tr>
                        <tr>
                            <td><input type="number" value="{{$billetage->br_nb5}}" min="0" class="form-control form-control-sm" name="br_nb5" id="br_nb5" /></td>
                            <td>5</td>
                            <td><input type="number" min="0" class="form-control form-control-sm" name="br_nb5_total" id="br_nb5_total" readonly /></td>
                        </tr>
                        <tr>
                            <td><input type="number" value="{{$billetage->br_nb1}}" min="0" class="form-control form-control-sm" name="br_nb1" id="br_nb1" /></td>
                            <td>1</td>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group row">
                        ...
                        <input type="number"  value="{{$ctv->montantReconnu}}" min="0" name="montantReconnu" id="montantReconnu" class="form-control col-sm-7" required/>
                    </div>
                    <div class="form-group row">
                        <label for="ecartConstate" class="col-sm-5">Ecart constaté</label>
                        <input type="number" value="{{$ctv->ecartConstate}}" min="0" name="ecartConstate" id="ecartConstate" class="form-control col-sm-7" required/>
                    </div>
                    <div class="form-group row">
                        <label for="montantFinal" class="col-sm-5">Montant final</label>
                        <input type="number" value="{{$ctv->ecartConstate}}" min="0" name="montantFinal" id="montantFinal" class="form-control col-sm-7" required value={{$ctv->montantFinal}}/>
                    </div>
                </div>
                <div class="col"></div>
                <div class="col"></div>
                    ...
                    <div class="row" style="align-items: center;">
                        ...
                        <div class="col">
                            <div class="form-group row">
                                ...
                                <input type="number"  value="{{$ctv->billetsCalculesMontant}}" name="billetsCalculesMontant" id="caisse_bc" class="form-control col-sm-4"/>
                            </div>
                            <div class="form-group row">
