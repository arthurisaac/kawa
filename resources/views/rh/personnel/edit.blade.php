            ...
            <div class="col">
                ...
                <div class="form-group row">
                    ...
                    <select class="Combobox col-md-4" name="centreRegional" id="centre_regional" required >
                        <option  value={{ $personnel->centreRegional }}> {{ $personnel->centreRegional }}</option>
                    </select>
                </div>
        ...
        <div class="row">
            <div class="col-5">
                <div class="form-group row">
                    ...
                    <input type="text" name="nomPrenoms" class="form-control col-sm-6" value={{ $personnel->nomPrenoms }} required>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Date de naissance</label>
                    <input type="date" name="dateNaissance" class="form-control col-sm-6" value={{ $personnel->dateNaissance }}>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Date d’entrée dans la société</label>
                    <input type="date" name="dateEntreeSociete" class="form-control col-sm-6"  value={{ $personnel->dateEntreeSociete }}>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Date de sortie</label>
                    <input type="date" name="dateSortie" class="form-control col-sm-6" value={{ $personnel->dateSortie }}>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" name="fonction" class="form-control col-sm-6"  value={{ $personnel->fonction }}>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Service</label>
                    <input type="text" name="service" class="form-control col-sm-6"  value={{ $personnel->service }}>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Nature du contrat</label>
                    <select name="natureContrat" class="form-control col-sm-6" value={{ $personnel->natureContrat }}>
                ...
                <div class="form-group row">
                    ...
                    <input type="number" name="numeroCNPS" class="form-control col-sm-6" value={{ $personnel->numeroCNPS }}>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Situation matrimoniale</label>
                    <input type="text" name="situationMatrimoniale" class="form-control col-sm-6" value={{ $personnel->situationMatrimoniale }}>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Nombre d'enfants</label>
                    <input type="number" min="0" name="nombreEnfants" class="form-control col-sm-6" value={{ $personnel->nombreEnfants }}>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" name="adresseGeographique" class="form-control col-sm-6" value={{ $personnel->adresseGeographique }}>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Contact personnels</label>
                    <input type="text" name="contactPersonnel" class="form-control col-sm-6" value={{ $personnel->contactPersonnel }}>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Nom du père</label>
                    <input type="text" name="nomPere" class="form-control col-sm-6" value={{ $personnel->nomPere }}>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Nom de la mère</label>
                    <input type="text" name="nomMere" class="form-control col-sm-6" value={{ $personnel->nomMere }}>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Nom du conjoint</label>
                    <input type="text" name="nomConjoint" class="form-control col-sm-6" value={{ $personnel->nomConjoint }}>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Personnes à contacter en cas d'urgence</label>
                    <input type="text" name="personneContacter" class="form-control col-sm-6" value={{ $personnel->personneContacter }}>
                </div>
            </div>
        </div>
