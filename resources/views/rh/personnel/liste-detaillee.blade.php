                    ...
                    <div class="card-body pt-2">
                        <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-7">
                            ...
                            <div class="flex-grow-1 me-2">
                                <a href="#" class="fw-bolder text-gray-800 text-hover-primary fs-6">TOTAL PERSONNEL :</a>
                                <span class="text-muted fw-bold d-block"></span>
                            </div>
                            <!--end::Title-->
                            <!--begin::Lable-->
                            <span class="fw-bolder text-danger py-1 totalSite" id="totalSite">{{count($personnels)}}</span>
                            <!--end::Lable-->
                        </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group row">
                                        ...
                                        <input id="nature" type="text" name="nature" class="form-control col" value="{{$nature}}">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group row">
                                        <label for="situation_matrimonial" class="col-6">Situation matrimonial</label>
                                        <input id="situation_matrimonial" type="text" name="situation_matrimonial" class="form-control col" value="{{$nature}}">
                                    </div>
                                </div>
                                <div class="col"></div>
                                <div class="col"></div>
