...
background: linear-gradient(0deg, rgba(148,148,152,0.34217436974789917) 0%, rgba(220,211,172,1) 38%, rgba(255,216,1,1) 100%);">
                        ...
                        <div class="card-body bg-card-kawa 2">
                            <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-7">
                                ...
                                <div class="flex-grow-1 me-2">
                                    <a href="#" class="fw-bolder text-gray-800 text-hover-primary fs-6">TOTAL PERSONNEL
                                        :</a>
                                    <span class="text-muted fw-bold d-block"></span>
                                </div>
                                <!--end::Title-->
                                <!--begin::Lable-->
                                <span class="fw-bolder text-danger py-1 totalSite"
                                      id="totalSite">{{count($personnels)}}</span>
                                <!--end::Lable-->
                            </div>
                        ...
                        <div class="card card-xl-stretch">
                            ...
                            <div class="card-body bg-card-kawa 5">
                                <div class="row">
                                    ...
                                    <div class="d-flex flex-column mb-7 col-md-3 fv-row fv-plugins-icon-container">
                                        ...
                                        <select id="centre_regional" name="centre_regional"
                                            ...
                                            <option data-select2-id="select2-data-12-ubbm">
                                    ...
                                    <div class="d-flex flex-column mb-7 col-md-3 fv-row fv-plugins-icon-container">
                                        <label for="fonction"
                                               class="d-flex align-items-center fs-6 fw-bold form-label mb-2">Fonction</label>
                                        <input id="fonction" name="fonction" class="form-control form-control-solid"
                                               value="{{$fonction}}">
                                    </div>
                                    <div class="d-flex flex-column mb-7 col-md-3 fv-row fv-plugins-icon-container">
                                        <label for="service"
                                               class="d-flex align-items-center fs-6 fw-bold form-label mb-2">Service</label>
                                        <input id="service" name="service" class="form-control form-control-solid"
                                               value="{{$service}}">
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="d-flex flex-column mb-7 col-md-3 fv-row fv-plugins-icon-container">
                                        <label for="nature"
                                               class="d-flex align-items-center fs-6 fw-bold form-label mb-2">Nature
                                            contrat</label>
                                    ...
                                    <div class="d-flex flex-column mb-7 col-md-3 fv-row fv-plugins-icon-container">
                                        <label for="situation_matrimonial"
                                               class="d-flex align-items-center fs-6 fw-bold form-label mb-2">Situation
                                            matrimonial</label>
                                        <input id="situation_matrimonial" type="text" name="situation_matrimonial"
                                               class="form-control form-control-solid" value="{{$nature}}">
                                    </div>
                                    <div class="col"></div>
                                    <div class="col"></div>
                                </div>
                            ...
                            <div class="card-footer">
                                <a href="/personnel-liste-detaillee" class="btn btn-info btn-sm">Effacer</a>
                                <button class="btn btn-primary btn-sm" type="submit">Rechercher</button>
                                <a href="{{route('personnel.index')}}" class="btn btn-sm btn-primary">Nouveau</a>
                            </div>
                        </div>
                        @csrf
            ...
            <div class="card card-xl-stretch">
                <div class="card-body">
                    <table class="table table-bordered table-striped" style="width: 100%" id="liste">
                        <thead>
