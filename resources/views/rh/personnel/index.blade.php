                            ...
                            <div>
                                ...
                                <div class="row">
                                    <div class="col-5">
                                        ...
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label text-dark text-dark mb-2">Centre régional</label>
                            ...
                            <div>
                                ...
                                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="date" name="dateProchainDepartConge[]" class="form-control">
                                        </td>
                                        <td><input type="text" name="nombreJourPris[]" class="form-control"></td>
                                        <td><a class="btn btn-danger btn-sm"
                                               onclick="supprimerCongeTableLine(this)"></a></td>
                                    </tr>
                                ...
                                {{--<div class="row">
                                    <div class="col-5">
                                        <br/>
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label text-dark mb-2">Date du dernier départ en congé</label>
                                            <input type="date" name="dateDernierDepartConge" class="form-control col-sm-6">
                                        </div>
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label text-dark mb-2">Date du prochain départ en congé</label>
                                            <input type="date" name="dateProchainDepartConge" class="form-control col-sm-6">
                                        </div>
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label text-dark mb-2">Nombre de jours pris</label>
                                ...
                                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4"
                                    ...
                                    @for($i = 0; $i <= 2; $i++)
                                        <tr>
                                            ...
                                            <td><a class="btn btn-danger btn-sm"
                                                   onclick="supprimerSanctionTableLine(this)"></a>
                                            </td>
                                        </tr>
                                    @endfor
                                    </tbody>
                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div class="col-5">
                                        <br/>
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label text-dark text-dark mb-2">Adresse géographique</label>
                                        ...
                                        <div class="d-flex flex-column mb-7 col-md-12 fv-row fv-plugins-icon-container">
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label text-dark text-dark mb-2">Nom du père</label>
                                ...
                                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4"
                                    ...
                                    @for($i = 0; $i < 2; $i++)
                                        <tr>
                                            ...
                                            <td><input type="number" name="absence_nombre_jours[]" class="form-control">
                                            </td>
