        ...
        <form class="form-horizontal" method="post" action="{{ route('ssb.store') }}">
            ...
            <!-- INFORMATIONS GENERALE -->
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="checkbox">
                            <input type="radio" name="contrat_frequence_op[]" value="Coût unitaire">
                            <label>Coût unitaire</label>
                        </div>
                        <div class="checkbox">
                            <input type="radio" id="cb_fo_permanent" name="contrat_frequence_op[]" value="Coût forfetaire">
                            <label for="cb_fo_permanent">Coût forfetaire</label>
                        </div>
                        <br />
                        <div class="form-group row">
                            <label class="col-sm-3">Montant</label>
                            <input type="number" value="Montant" class="form-control col-sm-9">
                        </div>
                        <br/>
                    </div>
                </div>
