                        ...
                        <div class="card-body pt-2">
                            <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-7">
                                ...
                                <div class="flex-grow-1 me-2">
                                    <a href="#" class="fw-bolder text-gray-800 text-hover-primary fs-6">Total entrée</a>
                                    <span class="text-muted fw-bold d-block"></span>
                                </div>
                                <!--end::Title-->
                                <!--begin::Lable-->
                                <span class="fw-bolder text-warning py-1" id="totalEntree"></span>
                                <!--end::Lable-->
                            </div>
                            <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-7">
                                ...
                                <!--begin::Title-->
                                <div class="flex-grow-1 me-2">
                                    <a href="#" class="fw-bolder text-gray-800 text-hover-danger fs-6">Total sortie</a>
                                    <span class="text-muted fw-bold d-block"></span>
                                </div>
                                <!--end::Title-->
                                <!--begin::Lable-->
                                <span class="fw-bolder text-danger py-1"  id="totalSortie"></span>
                                <!--end::Lable-->
                            </div>
                        </div>
                        <!--end::Body-->
                        ...
                        <div class="card card-xl-stretch">
                            ...
                            <div class="card-body pt-5">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group row">
                                            <label class="col" for="mouvement">Mouvement</label>
