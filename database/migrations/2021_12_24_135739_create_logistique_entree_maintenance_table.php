...
class CreateLogistiqueEntreeMaintenanceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('logistique_entree_maintenance', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('logistique_entree_maintenance');
    }
}
