...
class LogistiqueSortieMaintenanceController extends Controller
{
    ...
    {
        $sorties = LogistiqueSortieMaintenance::where('localisation_id', Auth::user()->localisation_id)->get();
    ...
    {
        $sortie = LogistiqueSortieMaintenance::where('localisation_id', Auth::user()->localisation_id)->find($id);
